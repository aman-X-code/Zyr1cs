          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : `repeating-conic-gradient(from 0deg at 50% 50%, #00ff87 0%, #60efff 10%, #ff00ff 20%, #ffd700 30%, #00ff87 40%)`,
        ...
        >
          <div
            className={cn(
              ...
              "after:opacity-[calc(var(--active)*1)] after:transition-opacity after:duration-200",
